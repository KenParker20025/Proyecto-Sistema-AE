...
<div class="container">
    ...
    <div class="title-container">
        <h2 class="title">Registro de Docentes</h2>
        </div>
        <form action="procesar_registro.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="clave" name="clave" placeholder="Ingrese su clave">
            </div>
            <div class="form-group">
    ...
    function registrar() {
        ...
        if (nombre === '' || apellidoPaterno === '' || apellidoMaterno === '' || clave === '' || correo === '' || usuario === '' || contraseña === '') {
            Swal.fire({
                icon: 'error',
                title: 'Error',
        ...
        fetch('procesar_registro.php', {
            ...
            body: 'nombre=' + nombre + '&apellidoPaterno=' + apellidoPaterno + '&apellidoMaterno=' + apellidoMaterno + '&clave=' + clave + '&correo=' + correo + '&usuario=' + usuario + '&contraseña=' + contraseña
        })
